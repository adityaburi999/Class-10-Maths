...
2. **Question:** Find distance between (-2,5) and (4,1).
   ...
   **Solution:** sqrt((6)^2+(-4)^2)=sqrt(52)=2sqrt(13).
...
24. **Question:** Find coordinates of point that divides (2,6), (8,0) in ratio 3:1.
    ...
    **Solution:** Using section formula with A(2,6),B(8,0),m:n=3:1: P(((m x_2+n x_1)/(m+n)),((m y_2+n y_1)/(m+n)))=(((3×8+1×2)/(4)),((3×0+1×6)/(4)))=(((13)/(2)),((3)/(2))).
...
29. **Question:** Find whether triangle with sides from points (0,0),(2,2),(4,0) is isosceles.
    ...
    **Solution:** Distances: sqrt(8),sqrt(8),4. Two equal sides, so isosceles.
...
43. **Question:** Find point dividing (-2,4), (6,-8) in ratio 3:1.
    ...
    **Solution:** (((3×6+1(-2))/(4)),((3(-8)+1×4)/(4)))=(4,-5).
